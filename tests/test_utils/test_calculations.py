...
class TestBasicCalculations:
    ...
    def test_calculate_monthly_loan_payment_normal_case(self):
        ...
        expected_payment = loan_amount * (monthly_rate * (1 + monthly_rate)**total_payments) / \
                          ((1 + monthly_rate)**total_payments - 1)
        
        result = calculate_monthly_loan_payment(loan_amount, interest_rate, loan_period_years)
    ...
    def test_calculate_monthly_cashflow(self):
        ...
        result = calculate_monthly_cashflow(monthly_rent, monthly_loan_payment, monthly_expenses)
